          ...
          <nav className="space-y-1">
            ...
            <Collapsible open={isFoldersOpen} onOpenChange={setIsFoldersOpen}>
              ...
              <CollapsibleContent className="space-y-1 pl-6">
                <Link
                  href="/dashboard/saved/tech"
                  className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                    isActive("/dashboard/saved/tech")
                      ? "bg-slate-100 text-slate-900"
                      : "text-slate-500 hover:bg-gray-50 hover:text-slate-900"
                  }`}
                >
                ...
                <Link
                  href="/dashboard/saved/news"
                  className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                    isActive("/dashboard/saved/news")
                      ? "bg-slate-100 text-slate-900"
                      : "text-slate-500 hover:bg-gray-50 hover:text-slate-900"
                  }`}
                >
                ...
                <Link
                  href="/dashboard/saved/sports"
                  className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                    isActive("/dashboard/saved/sports")
                      ? "bg-slate-100 text-slate-900"
                      : "text-slate-500 hover:bg-gray-50 hover:text-slate-900"
                  }`}
                >
        ...
        <div className="flex items-center gap-3 pt-6 border-t border-gray-100">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="cursor-pointer text-slate-400 hover:text-slate-600 p-1 rounded">

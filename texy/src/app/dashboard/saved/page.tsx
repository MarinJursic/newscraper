...
const MOCK_ARTICLES: SavedArticle[] = [
  {
    ...
    summary:
      "A deep dive into the experimental no-GIL build in Python 3.13 and what it means for multi-threaded performance.",
    sentiment: "positive",
    isRead: false,
    folder: "All Saved",
  },
  {
    ...
    summary:
      "CVE-2024-2389 allows unauthenticated attackers to execute arbitrary code. Patch immediately.",
    sentiment: "critical",
    isRead: true,
    folder: "All Saved",
    isFavorite: true,
  },
  {
    ...
    summary:
      "OpenAI introduces Sora, a text-to-video model capable of generating highly detailed scenes up to a minute long.",
    sentiment: "positive",
    isRead: false,
  ...
  },
  {
    ...
    summary:
      "New flagship model rivals GPT-4 in reasoning capabilities and is available on Azure.",
    sentiment: "positive",
    isRead: false,
          ...
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar mask-linear-fade w-full">
            {folders.map((folder) => (
              <button
                ...
                className={`cursor-pointer px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 whitespace-nowrap flex-shrink-0 flex items-center gap-2 ${

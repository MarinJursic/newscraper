...
type Category = 'All' | 'Security' | 'Product Launch' | 'Legal' | 'Market' | 'AI' | 'DevOps';
                    ...
                    <div className="flex items-center gap-2 overflow-x-auto no-scrollbar mask-linear-fade w-full">
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`cursor-pointer px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 whitespace-nowrap flex-shrink-0 ${activeCategory === cat
            ...
            <div className="p-6 lg:p-8 space-y-8 max-w-7xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <TrendingWidget keywords={trendingKeywords} />
                    </div>
                </div>
            </div>
        </main>

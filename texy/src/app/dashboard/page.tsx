...
const Dashboard = () => {
    ...
    const { articles, categories, trendingKeywords, statistics, loading, error } = useFilteredArticles(
        activeCategory,
        searchQuery
    );
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        {
                            trendingKeywords && statistics && (
                                <TrendingWidget keywords={trendingKeywords} totalArticles={statistics.total_articles} />
                            )
                        }
                    </div>
                </div>

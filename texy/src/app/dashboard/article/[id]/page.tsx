        ...
        >
          ...
          <div className="text-right">
            <div className="font-mono font-medium text-slate-900">
              ${(stock.last_price || stock.price || 0).toFixed(2)}
            </div>
            <div
...
const generateFallbackTrendData = (): Array<{
  label: string;
  value: number;
}> => {
  const now = new Date();
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Search volume trend (Last 6 Months)
            </p>
          </div>
        </div>
        {!hasValidData && (
    ...
    relevantHighlights.forEach((highlight) => {
      ...
      if (index !== -1) {
        ...
        result.push(
          <mark
            key={highlight.id}
            className="bg-yellow-200 px-0.5 cursor-pointer hover:bg-yellow-300 transition-colors rounded-sm"
      ...
      <div className="flex h-screen overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white text-xs font-medium rounded-full hover:bg-slate-800 transition-all shadow-md"
                >
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-16">
                <TrendsGraph
                  ...
                  trendDirection={
                    article.visual_data?.trend_graph?.trend_direction
                  }
                />
              </div>
            </div>
        ...
        <aside className="w-[350px] border-l border-gray-200 bg-slate-50/50 flex flex-col h-screen overflow-hidden shadow-inner">
          <div className="flex-1 overflow-y-auto">
            ...
            <KeywordsWidget
              keywords={article.metadata?.keywords || sidebarKeywords}
            />
            ...
            {/* Related Topics */}
            {(article.trends?.recommended ||
              article.trends?.related_topics) && (
              <RelatedTopicsWidget
